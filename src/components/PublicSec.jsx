                ...
                <div className="flex mt-14">
                    <div className="flex flex-col">
                        <div className="flex items-center">
                            <p className="py-[10px] px-5 border border-white rounded-xl text-white font-Montserrat font-bold text-[50px] flex items-center">86</p>
                            <span className="flex font-Montserrat font-normal  text-[50px] text-white mx-[14px]">:</span>
                        </div>
                        <p className="text-lg font-medium font-Montserrat mt-[5px] ml-[31px] text-white">Days</p>
                    </div>  
                    <div className="flex flex-col">
                        <div className="flex items-center">
                            <p className="py-[10px] px-5 border border-white rounded-xl text-white font-Montserrat font-bold text-[50px] flex items-center">05</p>
                            <span className="flex font-Montserrat font-normal  text-[50px] text-white mx-[14px]">:</span>
                        </div>
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center">
                            <p className="py-[10px] px-5 border border-white rounded-xl text-white font-Montserrat font-bold text-[50px] flex items-center">20</p>
                            <span className="flex font-Montserrat font-normal  text-[50px] text-white mx-[14px]">:</span>
                        </div>
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center">
                            <p className="py-[10px] px-5 border border-white rounded-xl text-white font-Montserrat font-bold text-[50px] flex items-center">37</p>
                        </div>
