...
const WelcomeSec = () => {
    return (
        <div className="grid grid-cols-1 xl:grid-cols-2 items-end md:min-h-[709px]">
            <div className="max-w-[513px] mb-10 sm:mb-20">
                <p className=" font-Montserrat font-semibold text-white text-base  sm:text-lg lg:text-xl">Welcome to</p>
                <h1 className=" font-Montserrat font-black text-white text-[28px] xs:text-[30px] sm:text-[50px] lg:text-[65px]  mt-[5px]">The Future of E-Commerce</h1>
