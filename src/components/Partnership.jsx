...
const Partnership = () => {
    return (
        <div className='bg-[url(./assets/icons/Partnershipbg.svg)] bg-cover bg-no-repeat'>
            <div className='max-w-[453px] mx-auto pt-12 lg:pt-16 pb-10 lg:pb-14 px-3'>
                ...
                <img className=' duration-300 hover:scale-105 mt-5 sm:mt-8 md:mt-10 lg:mt-12' src={PartnershipLogo} alt="logo" />
            </div>
        </div>
    )
}
