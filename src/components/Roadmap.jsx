...
const Roadmap = () => {
    ...
    <div className={`${listing.BackGround} rounded-xl px-3 py-2`}>
        <p className=' font-Montserrat text-white font-bold text-[28px] opacity-50'>{listing.Number}</p>
        <h2 className={`${listing.paddingLeft} font-Montserrat text-white font-bold text-base xl:text-lg 2xl:text-xl mt-5 mb-[15px]`}>{listing.heading}</h2>
    </div>
    )
  return (
    <div className='container max-w-[1380px] mt-[100px]'>
        <div className='max-w-[672px] flex flex-col justify-center items-center mx-auto'>
            <h2 className='font-Montserrat text-[#32352C] font-bold text-center text-[50px]'>RoadMap</h2>
            <p className='font-Montserrat text-black opacity-70 font-normal text-center text-lg mt-[18px]'>Knowing our values, understanding the business idea and then, gradually, presenting the plans to the public is our way of doing things.</p>
            <img className='mt-16' src={roadmapImg} alt="roadmap image" />
        </div>
